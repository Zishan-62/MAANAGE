                ...
                child: Container(
                  ...
                  child: Form(
                    ...
                    child: Column(children: [
                      ...
                      //NAME
                      TextFormField(initialValue:fetchEmployees[i].ename ,
                        style: TextStyle(
                      ...
                      TextFormField(initialValue: fetchEmployees[i].econtact.toString(),
                      ...
                      TextFormField(initialValue: fetchEmployees[i].email.toString(),
                        style: TextStyle(
                            color: Color(0xFF3C5BFA),
                            fontFamily: "Montserrat",
                            fontWeight: FontWeight.w500),
                      ...
                      TextFormField(initialValue: fetchEmployees[i].dob ,
                        // readOnly: true,
                        style: TextStyle(
                            color: Color(0xFF3C5BFA),
                            fontFamily: "Montserrat",
                      ...
                      TextFormField(initialValue: fetchEmployees[i].address?[0]['addr'],
                        maxLength: 50,
                        style: TextStyle(
                            color: Color(0xFF3C5BFA),
                            fontFamily: "Montserrat",
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                ...
                                TextFormField(initialValue: fetchEmployees[i].address?[0]['city'],
                                  style: TextStyle(
                                      color: Color(0xFF3C5BFA),
                                      fontFamily: "Montserrat",
                                      fontWeight: FontWeight.w500),
                           ...
                           width:  MediaQuery.of(context).size.width*0.37,
                            ...
                            child: Column(
                              children: [
                                ...
                                TextFormField(initialValue: fetchEmployees[i].address?[0]['pincode'],
                                  style: TextStyle(
                                      color: Color(0xFF3C5BFA),
                                      fontFamily: "Montserrat",
                                      fontWeight: FontWeight.w500),
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                ...
                                TextFormField(initialValue: fetchEmployees[i].address?[0]['state'],
                                  style: TextStyle(
                                      color: Color(0xFF3C5BFA),
                                      fontFamily: "Montserrat",
                                      fontWeight: FontWeight.w500),
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                ...
                                TextFormField(initialValue: fetchEmployees[i].address?[0]['country'],
                                  style: TextStyle(
                                      color: Color(0xFF3C5BFA),
                                      fontFamily: "Montserrat",
                                      fontWeight: FontWeight.w500),
        ...
        persistentFooterButtons: [
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            SizedBox(
              ...
              width: MediaQuery.of(context).size.width*0.45,
              child: ElevatedButton(
                onPressed: () =>delete_employee(fetchEmployees[i].empid.toString()),
                style: ElevatedButton.styleFrom(
                  // padding: EdgeInsets.symmetric(horizontal: 50.0, vertical: 20.0),
      ...
      TextFormField(
        ...
        onTap: () async {
          ...
          if (pickedEOCdate != null) {
            setState(() {
              _dateofcontract.text = DateFormat('dd-MM-yyyy').format(pickedEOCdate);
            });
          }
        },
      ),
